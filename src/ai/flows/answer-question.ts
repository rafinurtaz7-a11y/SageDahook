'use server';
/**
 * @fileOverview Answers a question based on the documents in the knowledge base.
 *
 * - answerQuestion - A function that answers a question based on the documents in the knowledge base.
